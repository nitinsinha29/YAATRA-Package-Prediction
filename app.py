...
from flask import Flask, render_template, request #Rener_template will redirect to the home page
import numpy as np
import pickle

app =Flask(__name__) ##Intializing the picke app
model=pickle.load(open('yattra_modRan.pkl','rb'))#open the pkl file in read byte mode
